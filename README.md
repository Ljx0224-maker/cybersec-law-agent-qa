# 基于智能体的网络安全法律 GraphRAG 问答系统 (CyberLaw-Agent)



> **核心技术**：深度融合 LLM Agent + Neo4j 知识图谱 + FAISS 向量检索。通过“双路并发”与“确定性旁路”机制，将垂直领域问答召回率提升至 94.7%，彻底解决法条张冠李戴的幻觉问题。
...
* **工业级持久化**：采用 SQLite 管理会话，通过 UUID 与 SHA-256 哈希保障多用户会话隔离与数据安全。
...
| **底层大脑** | 智谱 GLM-4 (Chat-Agent) |

| **嵌入/检索** | ZhipuAI Embedding-3 / FAISS (Flat L2) |

| **交叉精排** | BGE-Reranker-v2-m3 (Transformer-based) |

| **存储层** | Neo4j (Graph) + SQLite (Relational) |

| **编排框架** | LangChain + Transformers + PyTorch |

| **前端展示** | Streamlit (Responsive Web UI) |
...
| 检索架构 | 名词解释召回率 | 责任认定准确率 | 综合召回率 |

| :--- | :--- | :--- | :--- |

| 纯向量 (FAISS) | 43.3% | 80.0% | 63.8% |

| 向量 + BGE 精排 | 65.0% | 89.0% | 78.7% |

| **本系统 (GraphRAG+旁路)** | **100%** | **94.0%** | **94.7%** |
...
**首页：**<img width="866" height="469" alt="image" src="https://github.com/user-attachments/assets/9785cfa4-58a6-4570-8a22-8b69af7e92c3" />

**问答交互页（主要功能）：**<img width="866" height="469" alt="image" src="https://github.com/user-attachments/assets/4f5cac5e-2898-4099-a1ce-3b40f0ad1de5" />

**系统管理员工作台界面：**<img width="866" height="462" alt="image" src="https://github.com/user-attachments/assets/fd957fac-d09a-4651-b909-b8dcd36c640c" />



<img width="866" height="464" alt="image" src="https://github.com/user-attachments/assets/9b9d7319-452d-49c7-954f-a2d3c9b29a14" />
